...
func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Rancher support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(rancher.Setup(mgr, o), "Cannot setup Rancher controllers")
